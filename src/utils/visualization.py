...
def ros_colorline_trajectory(traj):
    ...
    header = Header()
    return sensor_msgs_py.point_cloud2.create_cloud(header,fields,traji) # return pc2.create_cloud(header, fields, traji)
...
colors = {
    ...
    "light_blue":ColorRGBA(r=.44,g=.62,b=.8118,a=1.0)
}
